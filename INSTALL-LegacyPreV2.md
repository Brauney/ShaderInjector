...
**This is the installation guide for older shader injector versions before 2.0. If you are installing the latest version please ignore this guide and find it [here](https://github.com/frostbone25/ShaderInjector/blob/main/INSTALL.md).**

# Installation Guide *(Pre v2.0)*
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step1-a1.png" width="32%" />
    <img src="GithubContent/InstallLegacyPreV2/step1-b1.png" width="32%" />
    <img src="GithubContent/InstallLegacyPreV2/step1-c1.png" width="32%" />
</p>

You will see a ```D3DDriverByteCodeBlob``` file, **simply delete it!**

<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step1-d1.png" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step1-e1.png" width="49%" />
</p>
...
![quick-tip-steam](GithubContent/InstallLegacyPreV2/quick-tip-steam.png)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step2-a1.png" width="32%" />
    <img src="GithubContent/InstallLegacyPreV2/step2-b1.png" width="32%" />
    <img src="GithubContent/InstallLegacyPreV2/step2-c1.png" width="32%" />
</p>

![step2-d1](GithubContent/InstallLegacyPreV2/step2-d1.png)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step2-e1.png" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step2-f1.png" width="49%" />
</p>

Open our zip file and copy or drag ```dsound.dll``` and ```ShaderInjector``` into the directory as shown.

![step2-d1](GithubContent/InstallLegacyPreV2/step2-g1.png)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step3-a1.png" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step3-b1.png" width="49%" />
</p>
...
![step3-c1](GithubContent/InstallLegacyPreV2/step3-c1.jpg)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step4-a1.jpg" width="32%" />
    <img src="GithubContent/InstallLegacyPreV2/step4-b1.jpg" width="32%" />
    <img src="GithubContent/InstallLegacyPreV2/step4-c1.jpg" width="32%" />
</p>

*Developer Settings -> Stream Pipelines -> Pixel Shaders*

![step4-d1](GithubContent/InstallLegacyPreV2/step4-d1.jpg)
...
![step4-d2.png](GithubContent/InstallLegacyPreV2/step4-d2.png)
...
![step4-e1](GithubContent/InstallLegacyPreV2/step4-e1.jpg)
...
![step4-f1](GithubContent/InstallLegacyPreV2/step4-f1.jpg)

![step4-g1](GithubContent/InstallLegacyPreV2/step4-g1.png)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step4-i1.png" width="24%" />
    <img src="GithubContent/InstallLegacyPreV2/step4-j1.png" width="24%" />
    <img src="GithubContent/InstallLegacyPreV2/step4-k1.png" width="24%" />
    <img src="GithubContent/InstallLegacyPreV2/step4-l1.png" width="24%" />
</p>
...
![step4-m1](GithubContent/InstallLegacyPreV2/step4-m1.png)

**```Rebuild Shader Replacement```**

![sstep4-n1.jpg](GithubContent/InstallLegacyPreV2/step4-n1.jpg)
...
![step4-h1](GithubContent/InstallLegacyPreV2/step4-h1.png)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step5-a1.jpg" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-b1.jpg" width="49%" />
</p>
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step5-c1.jpg" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-d1.jpg" width="49%" />
</p>
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step5-e1.jpg" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-f1.jpg" width="49%" />
</p>
...
![step5-g1](GithubContent/InstallLegacyPreV2/step5-g1.jpg)

![step5-h1](GithubContent/InstallLegacyPreV2/step5-h1.jpg)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step5-i1.jpg" width="24%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-j1.jpg" width="24%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-k1.jpg" width="24%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-l1.jpg" width="24%" />
</p>
...
![step5-m1](GithubContent/InstallLegacyPreV2/step5-m1.jpg)

**```Rebuild Shader Replacement```**

![step5-n1.jpg](GithubContent/InstallLegacyPreV2/step5-n1.jpg)
...
<p float="left">
    <img src="GithubContent/InstallLegacyPreV2/step5-p1.jpg" width="49%" />
    <img src="GithubContent/InstallLegacyPreV2/step5-p1.jpg" width="49%" />
</p>
