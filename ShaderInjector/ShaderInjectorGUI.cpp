...
namespace ShaderInjectorGUI
{
	...
	void DrawReplacementPSOList(const ShaderReplacement::ShaderReplacementDisk& replacement)
	{
	...
	void DrawRuntimeLogTextBox(const std::string* logText)
	{
	...
	void UI_ShaderReplacements()
	{
		if (ImGui::CollapsingHeader("Shader Replacements"))
		{
			...
			DrawReplacementPSOList(replacement);
